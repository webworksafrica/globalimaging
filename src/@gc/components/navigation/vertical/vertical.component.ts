...
import { FuseNavigationItem, FuseVerticalNavigationAppearance, FuseVerticalNavigationMode, FuseVerticalNavigationPosition } from '@gc/components/navigation/navigation.types';
import { FuseNavigationService } from '@gc/components/navigation/navigation.service';
import { FuseScrollbarDirective } from '@gc/directives/scrollbar/scrollbar.directive';
import { FuseUtilsService } from '@gc/services/utils/utils.service';
